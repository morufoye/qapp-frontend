...
const ForgotPassword = (props) => {
    ...
    const tokenData =
        [
            {name: "username", label: "Enter the email or phone number associated with your account to reset your password ", placeholder: "Email of Phone Number", id:"otp", type:"password", value: userInput.username, tag:"input"},
        ]
        ...
        <>
            {
                ...
                <>
                    { showTokenInputer ?
                        <div className="max-w-md mx-auto">
                            <div className="max-w-7xl mx-auto my-4">
                                <h2 className="text-1l font-bold tracking-tight text-gray-900 sm:text-1">
                                    <span className="block">Reset Password</span><br></br>
                                </h2>
                            </div>
                        ...
                        :
                        <TokenInputer phoneNumber={userInput.phoneNumber} email={userInput.email} handleTokenResponse={handleTokenResponse}/>
                    }
                   }
                </>
            }
